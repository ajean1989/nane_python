"""modif nom table many to many lower case 2

Revision ID: 29fc1ec58102
Revises: 1fda4e38ea72
Create Date: 2023-07-25 11:41:08.316825
...
revision = '29fc1ec58102'
down_revision = '1fda4e38ea72'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('type', mysql.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('content_com', mysql.TEXT(), nullable=False),
